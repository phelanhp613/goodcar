<div class="search-box mb-3">
    <div class="card">
        ...
        <div class="card-body collapse show" id="form-search-box">
            <form action="{{ route('get.customer.list') }}" method="get">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="text-input">{{ trans("Customer name") }}</label>
                ...
                <div class="d-flex">
                    ...
                    <a href="{{ route('get.customer.list') }}" class="btn btn-outline-dark">{{ trans("Reset") }}</a>
                </div>
            </form>
        </div>
    </div>
