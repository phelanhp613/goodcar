...
class ProductCategory extends BaseModel
{
	...
	public function frontendData($slug)
	{
		...
		$view = 'Frontend::product.category.category_detail_with_listing';
	...
	public function getData($dataSlug)
	{
		...
		$products = Product::query()->with('variants', 'category');
		$request  = request()->all();
		...
		$products = $products->where('products.status', Status::STATUS_ACTIVE)
